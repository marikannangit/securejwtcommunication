 ...
 */
package com.securejwtcommunication.core.models;
...
import com.securejwtcommunication.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "securejwtcommunication/components/helloworld");
